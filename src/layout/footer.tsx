...
const Footer = () => {
  ...
  return (
    <footer className="py-10 lg:py-20 border-t border-violet-800 mt-10 lg:mt-20 space-y-12">
      ...
      {scrolled && (
        <button
          className="w-16 h-16 rounded-full flex items-center justify-center transition-all hover:bg-violet-950 bg-violet-500 shadow-2xl fixed bottom-16 -right-7 hover:right-2 z-10"
          onClick={goToTop}
        >
          <FaArrowUp />
        </button>
