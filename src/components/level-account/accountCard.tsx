...
const AccountCard = (props: any) => {
  ...
  return (
    <>
      <div className="rounded-2xl p-4 border-2 border-violet-900 hover:border-violet-500 shadow">
        ...
        <ul className="p-4 space-y-4">
          <li className="flex justify-start items-center gap-3">
            <FaGem className="text-violet-500 text-xl" /> {beTitle}
          </li>
          <li className="flex justify-start items-center gap-3">
            <FaGlobe className="text-violet-500 text-xl" /> {server}
          </li>
          <li className="flex justify-start items-center gap-3">
            <FaRegStar className="text-violet-500 text-xl" /> {MMR}
          </li>
          <li className="flex justify-start items-center gap-3">
            <FaLevelUpAlt className="text-violet-500 text-xl" /> {level}
          </li>
          <li className="flex justify-start items-center gap-3">
            <FaFire className="text-violet-500 text-xl" /> {lifeTime}
          </li>
          <li className="flex justify-start items-center gap-3">
